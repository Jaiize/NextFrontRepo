  ...
  return (
    <>
      ...
      <div className="flex flex-row justify-center w-full my-5 group">
        <div className={`flex flex-row w-[30%] ${theme === 'light' ? 'bg-white' : 'bg-[#323232]'} h-10 rounded-2xl sm: max-sm:w-[65%] sm: max-sm:h-9 transition-all duration-300`}>
          <BiSearch
            className="text-2xl mt-2 ml-3 cursor-pointer sm: max-sm:text-xl"
